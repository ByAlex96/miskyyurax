<footer class="footer fw-bolder cursor-pointer">
    <div class="container">
        ...
        <div class="row justify-content-center pb-4">
            <div class="col-md-4 text-center">
                <div class="iconos">
                    <a href="https://www.pinterest.es/Cakeshop07/" class="mx-2 text-dark fw-bold text-decoration-none">
                    ...
                    <a href="https://www.instagram.com/reposteria_peruana_/" class="mx-2 text-dark fw-bold text-decoration-none">
                    ...
                    <a href="https://x.com/perumuchogusto" class="mx-2 text-dark fw-bold text-decoration-none">
...
<script src="/miskyyurax/scripts/header.js"></script>