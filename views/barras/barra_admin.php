<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        <div class="container-fluid px-5">
            ...
            <a class="navbar-brand "><img src="/miskyyurax/photos/logo2prov.png" alt="" height="26"></a>
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/miskyyurax/index.php">Inicio</a>
                    </li>
                    <li class="nav-item">
